#Function to get the input interval dependent on the dimension
...
#Apply the evaluation function to the x-data
#Evaluation function is chosen based on the dimension
